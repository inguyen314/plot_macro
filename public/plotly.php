...
<html lang="en">
    <head>
        ...
        <title>Plotly - <?php if ($basin == null) { echo $cwms_ts_id; } else { echo $basin; }; ?></title>
            ...
            <div class="page-wrap">
                <div class="container-fluid" style="margin-bottom:50px;">
                    ...
                    if ($basin == null) {
                        ...
                        echo "<div id='timeSeriesPlot'></div>";
                    }
                    ?>
                    <div class="page-content">
                        ...
                        <div id="topPane" class="col-md backend-cp-collapsible">
                            ...
                            <div class="box-usace">
                                <h2 class="box-header-striped">
                                    <span class="titleLabel title">Plotly</span>
                                    <span class="rss"></span>
                                </h2>
                                <div class="box-content" style="background-color:white;margin:auto">
                                    <div class="content">
